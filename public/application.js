...
/***/ (function(module, exports, __webpack_require__) {
	...
	var dashboardEvents = __webpack_require__(15);
	var chooseTeamEvents = __webpack_require__(12);
	var gameTracker = __webpack_require__(16);
...
/***/ (function(module, exports) {
	...
	var config = {
	  apiOrigins: {
	    production: 'https://hidden-beyond-66396.herokuapp.com'
	  }
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var authHandlers = function authHandlers() {
	  ...
	  $('#login-modal-close').on('click', clearLogin);
	  $('#sign-up-modal-close').on('click', clearSignUp);
	  $(document).on('click', function () {
	    return $('#doc-message').text('');
	  });
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var signUpFailure = function signUpFailure() {
	  $('#sign-up-modal-message').text('User name already exists');
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var returningUser = function returningUser() {
	  var addedFixture = "<section id='added-fixture'></section>";
	  $('#NextFixture').append(addedFixture);
	  var html = "<hr class='featurette-divider'> <h2> Next Fixture </h2> <script src='//code.jquery.com/jquery-2.1.4.min.js'></script><script>(function(d, s, id) {var js, fjs = d.getElementsByTagName(s)[0];if (d.getElementById(id)) return;js = d.createElement(s); js.id = id;js.src='https://statsfc-4f51.kxcdn.com/widget/next-fixture-1.0.js';fjs.parentNode.insertBefore(js, fjs);}(document, 'script', 'statsfc-next-fixture-js'));</script><div id='next-fixture-div' class='statsfc-next-fixture'data-key='bXBdah2OOD0LsTjdOIVNZ7cdIqHzM4WdQmcsLO_X'data-team='test'data-use-default-css='true'></div>";
	  var replaced = html.replace('test', store.team);
	...
	var chooseTeamHandlers = function chooseTeamHandlers() {
	  $('.team-choice').on('click', onChooseTeam);
	  $('#change-favorite-team').on('click', onChangeTeam);
	};

	module.exports = {
	  chooseTeamHandlers: chooseTeamHandlers,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var chooseTeam = function chooseTeam(data) {
	  return $.ajax({
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var chooseTeamSuccess = function chooseTeamSuccess() {
	  $('#ChooseTeam').hide();
	  $('#Dashboard').show();
	  $('#TeamName').html(store.team);
	  $('#GameTracker').hide();
	...
	var chooseTeamFailure = function chooseTeamFailure() {
	  $('#doc-message').text('Unable to Choose Teams at this time');
	};

	module.exports = {
	  chooseTeamSuccess: chooseTeamSuccess,
	  chooseTeamFailure: chooseTeamFailure
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var dashboardHandlers = function dashboardHandlers() {
	  // buttons for showing / hiding on dashboard
	  $('#next-fixture-button').on('click', function () {
	    return $('#NextFixture').toggle();
	  });
	  $('#top-scorers-button').on('click', function () {
	    return $('#Top-Scorers').toggle();
	  });
	  $('#League-Table-button').on('click', function () {
	    return $('#League-Table').toggle();
	  });
	  $('#Form-button').on('click', function () {
	    return $('#Form').toggle();
	  });
	  $('#Fixtures-button').on('click', function () {
	    return $('#Fixtures').toggle();
	  });
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var onGameTracker = function onGameTracker() {
	  $('#GameTracker').show();
	  $('#Dashboard').hide();
	  $('#ChooseTeam').hide();
	  $('#OneGame').hide();
	...
	var getOneGame = function getOneGame() {
	  var div = $(this).closest('div');
	  var data = $(div).attr('data-id');
	  api.getOneGame(data).then(ui.getOneGameSuccess).catch(ui.getOneGameFailure);
	};
	...
	var deleteGame = function deleteGame(event) {
	  event.preventDefault();
	  api.deleteGame(store.deleteGameId).then(ui.deleteGameSuccess).then(api.getGames).then(ui.getGamesSuccess).catch(ui.deleteGameFailure);
	};
	...
	var onCreateGame = function onCreateGame(event) {
	  ...
	  api.createGame(store.newGame).then(ui.createGameSuccess).catch(ui.createGameFailure);
	};

	var onEditCurrentGameDetails = function onEditCurrentGameDetails() {
	  $('#CurrentGameDetailsDiv').hide();
	  $('#NewGameInputArea').show();
	  $('#EditGameForm').show();
	};

	var onCancelEditGameDetails = function onCancelEditGameDetails() {
	...
	var editGameDetails = function editGameDetails(event) {
	  event.preventDefault();
	  ...
	  api.editGameDetails().then(ui.editGameDetailsSuccess).catch(ui.editGameDetailsFailure);
	};
	...
	var newEvent = function newEvent(event) {
	  ...
	  api.newEvent().then(function () {
	    return api.getOneGame(store.newGame.id);
	  }).then(ui.onEditGameFromShowSuccess).catch(ui.newEventFailure);
	};
	...
	var onEditGameFromShow = function onEditGameFromShow() {
	  var div1 = $(this).closest('div');
	  var div2 = $(div1).closest('div');
	  var id = $(div2).attr('data-id');
	  api.getOneGame(id).then(ui.onEditGameFromShowSuccess).catch(ui.onEditGameFromShowFailure);
	};

	var gameTrackerHandlers = function gameTrackerHandlers() {
	...
	module.exports = {
	  gameTrackerHandlers: gameTrackerHandlers
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var getOneGame = function getOneGame(id) {
	  return $.ajax({
	...
	var editGameDetails = function editGameDetails() {
	  return $.ajax({
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var store = __webpack_require__(10);
	var showGamesTemplate = __webpack_require__(19);
	var showOneGameTemplate = __webpack_require__(39);
	var currentGameDetailsTemplate = __webpack_require__(40);
	var eventFeedTemplate = __webpack_require__(41);
	var noEventsTemplate = __webpack_require__(42);
	...
	var getGamesSuccess = function getGamesSuccess(games) {
	  ...
	  //   console.log(store.games)
	  var userGames = store.games.filter(function (game) {
	    return game._owner === store.user.id;
	  });
	  var showGames = showGamesTemplate({
	    games: userGames
	  });
	...
	var getOneGameSuccess = function getOneGameSuccess(game) {
	  $('#NewGame').hide();
	  // const dateConvert = function(input) {
	  ...
	  $('#GamesList').hide();
	  $('#OneGame').show();
	  var showGame = showOneGameTemplate({
	    game: game.game
	  });
	  var showNoEvents = noEventsTemplate({
	    game: game.game
	  });
	...
	var getOneGameFailure = function getOneGameFailure() {
	...
	var createGameSuccess = function createGameSuccess(data) {
	  ...
	  var showCurrentGameDetails = currentGameDetailsTemplate({
	...
	var editGameDetailsSuccess = function editGameDetailsSuccess() {
	  // const dateConvert = function (input) {
	  //   const array = input.split('-')
	  //   const fixedArray = []
	  //   fixedArray[0] = array[1]
	...
	var editGameDetailsFailure = function editGameDetailsFailure() {
	  $('#doc-message').text('Unable to Edit Game');
	};

	var newEventSuccess = function newEventSuccess() {
	  document.getElementById('NewEventForm').reset();
	  store.deleteEventId = null;
	  var showEventFeedTemplate = eventFeedTemplate({
	    events: store.newGame.events
	  });
	  $('#EventFeed').html(showEventFeedTemplate);
	};

	var newEventFailure = function newEventFailure() {
	...
	var onEditGameFromShowSuccess = function onEditGameFromShowSuccess(data) {
	  $('#GamesList').hide();
	  $('#OneGame').hide();
	  $('#ReturnFromNewGameButton').show();
	  $('#NewGame').show();
	...
	var onEditGameFromShowFailure = function onEditGameFromShowFailure() {
	  $('#doc-message').text('Unable to Edit Game');
	};
	...
	module.exports = {
	  ...
	  getOneGameSuccess: getOneGameSuccess,
	  getOneGameFailure: getOneGameFailure,
	  ...
	  editGameDetailsSuccess: editGameDetailsSuccess,
	  editGameDetailsFailure: editGameDetailsFailure,
	  newEventSuccess: newEventSuccess,
	  newEventFailure: newEventFailure,
	  // deleteEventSuccess,
	  // deleteEventFailure,
	  onEditGameFromShowSuccess: onEditGameFromShowSuccess,
	  onEditGameFromShowFailure: onEditGameFromShowFailure
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "\n  <div class=\"panel panel-info\" >\n  <div class=\"panel-heading\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n        <button class='allGamesButton btn btn-primary'>"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.home : stack1), depth0))
	    + " vs. "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.away : stack1), depth0))
	    + " ( "
	  ...
	  return "\n<br>\n  <div class=\"panel panel-info\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n      <div class=\"panel-heading\" >\n        <a id='allGamesButton' class=\"btn btn-primary\" data-toggle=\"collapse\" href=\"#collapseAllGames\" aria-expanded=\"false\" aria-controls=\"collapseAllGames\">\n        "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.home : stack1), depth0))
	    + " vs. "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.away : stack1), depth0))
	    + " - "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.date : stack1), depth0))
	    + "</a>\n</div>\n<div class=\"collapse\" id='collapseAllGames'>\n      <div class=\"panel-body\" >\n        <br>\n        <table class=\"table\">\n          <h3> Game Events </h3>\n          <thead>\n              <td> Minute</td>\n              <td> Event Type</td>\n              <td> Player</td>\n          </thead>\n          <tbody>\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),((stack1 = blockParams[0][0]) != null ? stack1.events : stack1),{"name":"each","hash":{},"fn":container.program(4, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "            </tbody>\n        <br>\n      </div>\n    </div>\n  </div>\n";
	},"4":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1, alias1=container.lambda, alias2=container.escapeExpression;

	  return "            <tr>\n                <td>"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.minute : stack1), depth0))
	    + "</td>\n                <td>"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.eventType : stack1), depth0))
	    + "</td>\n                <td>"
	  ...
	  return "\n"
	    + ((stack1 = helpers.each.call(alias1,(depth0 != null ? depth0.games : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "\n\n\n<!-- "
	    + ((stack1 = helpers.each.call(alias1,(depth0 != null ? depth0.games : depth0),{"name":"each","hash":{},"fn":container.program(3, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + " -->\n";
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "<div class ='container'>\n  <div class=\"panel panel-info\" >\n      <div class=\"panel-heading\" >\n        <a class=\"btn btn-primary\" data-toggle=\"collapse\" href=\"#collapseAllGames\" aria-expanded=\"false\" aria-controls=\"collapseAllGames\">\n        "
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.game : depth0)) != null ? stack1.home : stack1), depth0))
	    + " vs. "
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.game : depth0)) != null ? stack1.away : stack1), depth0))
	    + " ( "
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.game : depth0)) != null ? stack1.date : stack1), depth0))
	    + " )</a>\n      </div>\n</div>\n<div class=\"collapse\" id='collapseAllGames'>\n    <div data-id=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.game : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\">\n      <!-- <h5> Actions: </h5> -->\n      <hr class='featurette-divider'>\n      <button data-target=\"#deleteGameModal\" data-toggle=\"modal\" class=\"deleteGame btn btn-danger\"> Delete Game </button>\n      <button class='backToAllGamesButtons btn btn-primary'> Return to All Games</button>\n      <button class='editGameFromShow btn btn-info'> Edit Game</button>\n    </div>\n      <div class=\"panel-body\" >\n        <br>\n        <table class=\"table\">\n          <h3> Game Events </h3>\n          <thead>\n              <td> Minute</td>\n              <td> Team</td>\n              <td> Event Type</td>\n              <td> Player</td>\n          </thead>\n          <tbody>\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),((stack1 = (depth0 != null ? depth0.game : depth0)) != null ? stack1.events : stack1),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "            </tbody>\n        <br>\n      </div>\n    </div>\n  </div>\n";
	},"useData":true,"useBlockParams":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<div class ='container'>\n<h2> "
	    ...
	    + " ( "
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.game : depth0)) != null ? stack1.date : stack1), depth0))
	    + " ) </h2>\n<button id='EditCurrentGameDetailsButton' class='btn btn-info'> Edit Details</button>\n</div>\n";
	},"useData":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "      <tr data-id=\""
	    ...
	    + "</td>\n          <td>"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.comment : stack1), depth0))
	    + "</td>\n          <td ><button  class='deleteEvent btn btn-danger' data-target='#deleteEventFeatureInProgress' data-toggle=\"modal\"> Delete Event</button></td>\n      </tr>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1, alias1=container.lambda, alias2=container.escapeExpression;
	  ...
	  return "<div class ='container'>\n<div class=\"panel-body\" >\n  <table class=\"table\">\n    <thead>\n        <td> Minute </td>\n        <td> Team</td>\n        <td> Event Type</td>\n        <td> Player</td>\n    </thead>\n    <tbody>\n"
	    ...
	    + "      </tbody>\n  <br>\n</div>\n</div>\n\n<!-- <button  class='editEvent btn btn-info'> Edit Event</button> -->\n\n\n\n<!--\n  <div class=\"panel panel-info\" >\n      <div class=\"panel-heading\" >\n        <a class=\"btn btn-primary\" data-toggle=\"collapse\" href=\".collapseAllEvents\" aria-expanded=\"false\" aria-controls=\"collapseAllEvents\">\n      "
	    + alias2(alias1(((stack1 = ((stack1 = (depth0 != null ? depth0.event : depth0)) != null ? stack1.event : stack1)) != null ? stack1.minute : stack1), depth0))
	    + "'</a>\n      </div>\n</div>\n<div class=\"collapse collapseAllEvents\" >\n      <div class=\"panel-body\" data-id="
	    + alias2(alias1(((stack1 = ((stack1 = (depth0 != null ? depth0.event : depth0)) != null ? stack1.event : stack1)) != null ? stack1.id : stack1), depth0))
	    + ">\n        <br>\n        <table class=\"table\">\n          <thead>\n              <td> Team</td>\n              <td> Event Type</td>\n              <td> Player</td>\n          </thead>\n          <tbody>\n            <tr>\n                <td>"
	    + alias2(alias1(((stack1 = ((stack1 = (depth0 != null ? depth0.event : depth0)) != null ? stack1.event : stack1)) != null ? stack1.team : stack1), depth0))
	    + "</td>\n                <td>"
	    + alias2(alias1(((stack1 = ((stack1 = (depth0 != null ? depth0.event : depth0)) != null ? stack1.event : stack1)) != null ? stack1.eventType : stack1), depth0))
	    + "</td>\n                <td>"
	    + alias2(alias1(((stack1 = ((stack1 = (depth0 != null ? depth0.event : depth0)) != null ? stack1.event : stack1)) != null ? stack1.player : stack1), depth0))
	    + "</td>\n                <td>"
	    + alias2(alias1(((stack1 = ((stack1 = (depth0 != null ? depth0.event : depth0)) != null ? stack1.event : stack1)) != null ? stack1.comment : stack1), depth0))
	    + "</td>\n            </tr>\n            </tbody>\n        <br>\n      </div>\n    </div> -->\n";
	},"useData":true,"useBlockParams":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<div class ='container'>\n  <div class=\"panel panel-info\" >\n      <div class=\"panel-heading\" >\n        <a class=\"btn btn-primary\" data-toggle=\"collapse\" href=\"#collapseAllGames\" aria-expanded=\"false\" aria-controls=\"collapseAllGames\">\n        "
	    ...
	    + " )</a>\n      </div>\n</div>\n<div class=\"collapse\" id='collapseAllGames'>\n    <div data-id=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.game : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\">\n      <!-- <h5> Actions: </h5> -->\n      <hr class='featurette-divider'>\n      <button data-target=\"#deleteGameModal\" data-toggle=\"modal\" class=\"deleteGame btn btn-danger\"> Delete Game </button>\n      <button class='backToAllGamesButtons btn btn-primary'> Return to All Games</button>\n      <button class='editGameFromShow btn btn-info'> Edit Game</button>\n    </div>\n      <div class=\"panel-body\" >\n        <br>\n        <h3> You have no events recorded for this game </h3>\n      </div>\n    </div>\n  </div>\n";
	},"useData":true});
